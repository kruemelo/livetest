...
(function () {
  ...
  console.log('process.cwd is "%s"', process.cwd());
  console.log('process.argv', process.argv);
  console.log('nw.App.fullArgv', nw.App.fullArgv);
  console.log('nw.App.dataPath %s', nw.App.dataPath);

  const cwd = nw.App.fullArgv[0];
  var configFilename = nw.App.fullArgv[1];
  var config;
  var testFiles = [];
  
  process.chdir(cwd);
  
  console.log('set process.cwd to "%s"', process.cwd());
